...
<div class="container">
    ...
    <select class="form-control" >
      ...
      <select multiple class="form-control"  name="jobs[]">
        <option name="jobs[]"value="passionné">Je suis passionné par mon travail.</option>
        <option name="jobs[]"value="ambitieux">Je suis ambitieux et motivé.</option>
        <option name="jobs[]"value="organisé">Je suis très organisé.</option>
        <option name="jobs[]"value="humaine">Je suis une personne humaine.</option>
        <option name="jobs[]" value="naturel">Je suis un leader naturel.</option>
      </select>
       <!------------------------------------------>
       <h2>sélectionner vous salaire</h2>
       <label class="radio-inline">
      <input type="radio" name="salary" checked>2000-3000£
    </label>
    <label class="radio-inline">
      <input type="radio" name="salary">3000-5000£
    </label>
    <label class="radio-inline">
      <input type="radio" name="salary">7000£ plus
    </label>
</div>
       <!--------------------->
